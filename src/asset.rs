...
use bevy::asset::*;
use crate::types::*;
pub fn get_guard_sprite(direction:&Direction,index:usize) -> String {
    (match direction {
        Direction::Up => match index {
            2 => "embedded://day6vis/sprites/Up2.png",
            3 => "embedded://day6vis/sprites/Up3.png",
            _ => "embedded://day6vis/sprites/Up1.png",
        },
        Direction::Down => match index {
            2 => "embedded://day6vis/sprites/Down2.png",
            3 => "embedded://day6vis/sprites/Down3.png",
            _ => "embedded://day6vis/sprites/Down1.png",
        },
        Direction::Left => match index {
            2 => "embedded://day6vis/sprites/Left2.png",
            3 => "embedded://day6vis/sprites/Left3.png",
            _ => "embedded://day6vis/sprites/Left1.png",
        },
        Direction::Right => match index {
            2 => "embedded://day6vis/sprites/Right2.png",
            3 => "embedded://day6vis/sprites/Right3.png",
